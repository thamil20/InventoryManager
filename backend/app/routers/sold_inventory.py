...
@router.get('/', response_model=List[schemas.sold_inventory.Response])
...
@router.get('/{item_id}', response_model=schemas.sold_inventory.Response)
...
@router.put('/{item_id}', response_model=schemas.sold_inventory.Response)
...
@router.delete('/{item_id}', response_model=schemas.sold_inventory.Response)
